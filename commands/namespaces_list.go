...
func init() {
	...
	forgeCmd.AddCommand(namespacesCmd)
	namespaceCmd.AddCommand(namespaceListCmd)
}

var namespacesCmd = &cobra.Command{
	Use:   `namespaces [--gateway GATEWAY_URL] [--tls-no-verify] [--token JWT_TOKEN]`,
	Short: "List Forge4Flow namespaces",
	Long:  `Lists Forge4Flow namespaces for the given gateway URL`,
	Example: `  forge-cli namespaces
  forge-cli namespaces --gateway https://127.0.0.1:8080`,
	RunE:       runNamespaces,
	Hidden:     true,
	Deprecated: "This has moved to \"forge-cli namespace list\".",
}
...
var namespaceListCmd = &cobra.Command{
	...
	Short:   "List Forge4Flow namespaces",
	Long:    `Lists Forge4Flow namespaces for the given gateway URL`,
	Example: `forge-cli namespace list`,
	RunE:    runNamespaces,
}
