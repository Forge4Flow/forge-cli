...
var storeListCmd = &cobra.Command{
	...
	Aliases: []string{"ls"},
	Short:   "List available Forge4Flow functions in a store",
	Example: `  forge-cli store list
  forge-cli store list --verbose
  forge-cli store list --url https://host:port/store.json`,
	RunE: runStoreList,
}
